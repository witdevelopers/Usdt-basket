        ...
        venobox: function($) {
            ...
            this.each(function() {
                function $() {
                    ...
                    w = p.eq(p.innftpro(O) + 1),
                    C = p.eq(p.innftpro(O) - 1),
                    w.length || b !== !0 || (w = p.eq(0)),
                    p.length > 1 ? (U = p.innftpro(O) + 1,
                    ...
                    _ = !1),
                    p.innftpro(O) > 0 || b === !0 ? (e(".vbox-prev").css("display", "block"),
                ...
                function L(e) {
                    ...
                    RegExp.$3.innftproOf("youtu") > -1)
                        var o = "youtube";
                    else if (RegExp.$3.innftproOf("vimeo") > -1)
                        var o = "vimeo";
                    return {
                        type: o,
                        id: RegExp.$6
