...
@Component({
  selector: 'app-request-for-withdrawl-admin-side',
  standalone: true,
  imports: [FormsModule, CommonModule, ReactiveFormsModule],
  templateUrl: './request-for-withdrawl-admin-side.component.html',
  styleUrls: ['./request-for-withdrawl-admin-side.component.css'],
})
export class RequestForWithdrawlAdminSideComponent implements OnInit {
  ...
  onFilterSubmit(): void {
    ...
    this.userService
      .getRequestsForWithdrawlAdminSide(userId, fromDate, toDate, status)
      .subscribe(
        (response) => {
  ...
  approveRequest(request: any): void {
    ...
    this.userService
      .approveOrRejectWithdrawlRequestAdminSide(approveRejectDetails)
      .subscribe(
        (response) => {
