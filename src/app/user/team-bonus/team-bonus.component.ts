...
@Component({
  ...
  templateUrl: './team-bonus.component.html',
  styleUrl: './team-bonus.component.css'
})
export class teambonusComponent implements OnInit {
  directs: any[] = [];
  ...
  getRoiIncome() {
    this.api
      .teambonus(this.filterUserId, this.startDate, this.endDate)
      .then((res: any) => {
