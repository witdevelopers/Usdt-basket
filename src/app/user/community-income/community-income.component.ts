...
@Component({
  selector: 'app-community-income',
  standalone: true,
  imports: [CommonModule,FormsModule],
  templateUrl: './community-income.component.html',
  styleUrl: './community-income.component.css'
})
export class CommunityIncomeComponent {
directs: any[] = [];
  ...
  constructor(private api: UserService) {
    ...
    if (this.isAdmin === false) {
      ...
      this.GetSingleLegIncomeDetails();
    }
  }
  ...
  GetSingleLegIncomeDetails() {
    this.api
      .GetSingleLegIncomeDetails(this.filterUserId, this.startDate, this.endDate)
      .then((res: any) => {
